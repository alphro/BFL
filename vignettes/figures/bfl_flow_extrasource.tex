...
\begin{tikzpicture}[font=\sffamily,
  ...
  \node[self, below=1.35cm of au] (self) {\textbf{Los Angeles}\\[1pt]\footnotesize summary $\phi$ (self)};
  \draw[arr] (ny.east) -- (bfl.west); \draw[arr] (se.east) -- (bfl.west); \draw[arr] (au.east) -- (bfl.west); \draw[arr] (self.east) -- (bfl.west); \draw[arr] (bfl.east) -- (la.west);
